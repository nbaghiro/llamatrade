...
if TYPE_CHECKING:
    from llamatrade_proto.generated import trading_pb2, trading_pb2_grpc
...
class TradingClient(BaseGRPCClient):
    ...
    def stub(self) -> trading_pb2_grpc.TradingServiceStub:
        ...
        if self._stub is None:
            try:
                from llamatrade_proto.generated import trading_pb2_grpc
    ...
    def _proto_to_order(self, proto: trading_pb2.Order) -> Order:
        ...
        status_map = {
            ...
            trading_pb2.ORDER_STATUS_SUBMITTED: OrderStatus.SUBMITTED,
            trading_pb2.ORDER_STATUS_ACCEPTED: OrderStatus.ACCEPTED,
            trading_pb2.ORDER_STATUS_PARTIAL: OrderStatus.PARTIAL,
        ...
        return Order(
            ...
            status=status_map.get(proto.status, OrderStatus.SUBMITTED),
