...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RequestPasswordReset = channel.unary_unary(
            "/llamatrade.AuthService/RequestPasswordReset",
            request_serializer=auth__pb2.RequestPasswordResetRequest.SerializeToString,
            response_deserializer=auth__pb2.RequestPasswordResetResponse.FromString,
            _registered_method=True,
        )
        self.ResetPassword = channel.unary_unary(
            "/llamatrade.AuthService/ResetPassword",
        ...
        self.VerifyEmail = channel.unary_unary(
            "/llamatrade.AuthService/VerifyEmail",
        ...
        self.ResendVerification = channel.unary_unary(
            "/llamatrade.AuthService/ResendVerification",
            request_serializer=auth__pb2.ResendVerificationRequest.SerializeToString,
            response_deserializer=auth__pb2.ResendVerificationResponse.FromString,
            _registered_method=True,
        )
...
class AuthServiceServicer(object):
    ...
    def RequestPasswordReset(self, request, context):
        """Password reset + email verification (unauthenticated, token-driven)"""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "RequestPasswordReset": grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=auth__pb2.RequestPasswordResetRequest.FromString,
            response_serializer=auth__pb2.RequestPasswordResetResponse.SerializeToString,
        ),
        ...
        "ResendVerification": grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=auth__pb2.ResendVerificationRequest.FromString,
            response_serializer=auth__pb2.ResendVerificationResponse.SerializeToString,
        ),
...
class AuthService(object):
    ...
    def RequestPasswordReset(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/llamatrade.AuthService/RequestPasswordReset",
            auth__pb2.RequestPasswordResetRequest.SerializeToString,
            auth__pb2.RequestPasswordResetResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def ResendVerification(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/llamatrade.AuthService/ResendVerification",
            auth__pb2.ResendVerificationRequest.SerializeToString,
            auth__pb2.ResendVerificationResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
