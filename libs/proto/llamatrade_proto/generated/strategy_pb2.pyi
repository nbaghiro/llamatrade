...
class Strategy(message.Message):
    ...
    REBALANCE_FIELD_NUMBER: builtins.int
    ...
    rebalance: builtins.str
    """rebalance frequency (daily/weekly/monthly/quarterly/annually), a projection of the DSL"""
...
class CreateExecutionRequest(message.Message):
    ...
    _HasFieldArgType: _TypeAlias = typing.Literal[
        "allocated_capital", b"allocated_capital", "context", b"context"
    ]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = typing.Literal[
        "allocated_capital",
