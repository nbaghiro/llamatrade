...
class PortfolioServiceServicer(metaclass=_abc_1.ABCMeta):
    ...
    def ListPortfolios(
        ...
        _portfolio_pb2.ListPortfoliosResponse
        | _abc.Awaitable[_portfolio_pb2.ListPortfoliosResponse]
    ): ...
    @_abc_1.abstractmethod
    def GetPerformance(
        self,
        ...
        _portfolio_pb2.GetPerformanceResponse
        | _abc.Awaitable[_portfolio_pb2.GetPerformanceResponse]
    ):
        """Performance"""
...
def add_PortfolioServiceServicer_to_server(
    servicer: PortfolioServiceServicer, server: _grpc.Server | _aio.Server
) -> None: ...
