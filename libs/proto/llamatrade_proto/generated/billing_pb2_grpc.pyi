...
class BillingServiceStub:
    ...
    """Payment methods"""
    CreateSetupIntent: _grpc.UnaryUnaryMultiCallable[
        _billing_pb2.CreateSetupIntentRequest, _billing_pb2.CreateSetupIntentResponse
    ]
...
class BillingServiceAsyncStub(BillingServiceStub):
    ...
    """Payment methods"""
    CreateSetupIntent: _aio.UnaryUnaryMultiCallable[
        _billing_pb2.CreateSetupIntentRequest, _billing_pb2.CreateSetupIntentResponse
    ]  # type: ignore[assignment]
...
class BillingServiceServicer(metaclass=_abc_1.ABCMeta):
    ...
    def CreateSetupIntent(
        ...
        _billing_pb2.CreateSetupIntentResponse,
        _abc.Awaitable[_billing_pb2.CreateSetupIntentResponse],
    ]: ...
    @_abc_1.abstractmethod
