...
import market_data_pb2 as _market_data_pb2
import sys
...
class MarketDataServiceStub:
    ...
    StreamHistoricalBars: _grpc.UnaryStreamMultiCallable[
        _market_data_pb2.StreamHistoricalBarsRequest, _market_data_pb2.Bar
    ]
    ...
    """Market info"""
    GetAssets: _grpc.UnaryUnaryMultiCallable[
        _market_data_pb2.GetAssetsRequest, _market_data_pb2.GetAssetsResponse
    ]
    """Reference data"""
...
class MarketDataServiceAsyncStub(MarketDataServiceStub):
    ...
    StreamHistoricalBars: _aio.UnaryStreamMultiCallable[
        _market_data_pb2.StreamHistoricalBarsRequest, _market_data_pb2.Bar
    ]  # type: ignore[assignment]
    ...
    """Market info"""
    GetAssets: _aio.UnaryUnaryMultiCallable[
        _market_data_pb2.GetAssetsRequest, _market_data_pb2.GetAssetsResponse
    ]  # type: ignore[assignment]
    """Reference data"""
...
class MarketDataServiceServicer(metaclass=_abc_1.ABCMeta):
    ...
    def GetAssets(
        ...
        _market_data_pb2.GetAssetsResponse, _abc.Awaitable[_market_data_pb2.GetAssetsResponse]
    ]:
        """Reference data"""
