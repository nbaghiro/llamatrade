...
class _ExecutionModeEnumTypeWrapper(
    ...
    EXECUTION_MODE_LIVE: _ExecutionMode.ValueType  # 2
...
EXECUTION_MODE_PAPER: ExecutionMode.ValueType  # 1
"""Paper trading (simulated)"""
EXECUTION_MODE_LIVE: ExecutionMode.ValueType  # 2
"""Live trading (real money)"""
...
class _ExecutionStatusEnumTypeWrapper(
    ...
    EXECUTION_STATUS_RUNNING: _ExecutionStatus.ValueType  # 2
    """Actively trading"""
    EXECUTION_STATUS_PAUSED: _ExecutionStatus.ValueType  # 3
    """Temporarily paused"""
    EXECUTION_STATUS_STOPPED: _ExecutionStatus.ValueType  # 4
    """Manually stopped"""
    EXECUTION_STATUS_ERROR: _ExecutionStatus.ValueType  # 5
...
EXECUTION_STATUS_PENDING: ExecutionStatus.ValueType  # 1
"""Created but not started"""
EXECUTION_STATUS_RUNNING: ExecutionStatus.ValueType  # 2
"""Actively trading"""
EXECUTION_STATUS_PAUSED: ExecutionStatus.ValueType  # 3
"""Temporarily paused"""
EXECUTION_STATUS_STOPPED: ExecutionStatus.ValueType  # 4
"""Manually stopped"""
