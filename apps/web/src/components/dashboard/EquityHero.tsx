...
import { boundsOf, buildPath, sliceByPeriod } from './chart';
...
export default function EquityHero() {
  ...
  return (
    <div className="bg-paper border-2 border-ink shadow-[4px_4px_0_#0d0d0d] flex flex-col">
      <div className="px-[18px] pt-4 pb-1.5 flex items-start justify-between">
        <div>
