...
export function BacktestGallery({ backtests, loading = false }: BacktestGalleryProps) {
  return (
    <div className="card flex-1 flex flex-col min-h-0">
      {/* Header */}
      <div className="px-4 py-3 border-b-2 border-ink flex-shrink-0">
        <h2 className="text-sm font-display uppercase tracking-tight text-ink">
          Recent Backtests
        </h2>
        <p className="text-[11px] font-mono uppercase tracking-wide text-ink/50 mt-0.5">
      ...
      {loading ? (
        ...
        <div className="flex-1 flex items-center justify-center py-12">
          <div className="text-center">
            <div className="w-10 h-10 bg-bone border-2 border-ink flex items-center justify-center mx-auto mb-3">
