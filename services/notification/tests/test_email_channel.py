...
class TestEmailChannelInit:
    ...
    def test_smtp_password_default_empty(self, email_channel):
...
class TestEmailChannelSend:
    ...
    async def test_send_returns_true(self, email_channel):
    ...
    async def test_send_with_html_body(self, email_channel):
    ...
    async def test_send_without_html_body(self, email_channel):
    ...
    async def test_send_empty_subject(self, email_channel):
    ...
    async def test_send_long_body(self, email_channel):
    ...
    async def test_send_multiple_recipients_string(self, email_channel):
