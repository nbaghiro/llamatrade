...
║                                      FastAPI :8870                                       ║
╠══════════════════════════════════════════════════════════════════════════════════════════╣
║ Connect / gRPC ASGI app  ·  tenant_id + user_id scoping on every call                    ║
╚══════════════════════════════════════════════════════════════════════════════════════════╝
                                              │
                                              ▼
╭──────────────────────────────────────────────────────────────────────────────────────────╮
│                             NotificationServicer  ·  9 RPCs                              │
├──────────────────────────────────────────────────────────────────────────────────────────┤
...
```
                           ...
                           ╰──────────────╯
                                   │
                                   │ evaluate alerts for symbol
                                   ▼
           ╭──────────────────────────────────────────────╮
           │              Notification :8870              │
           ├──────────────────────────────────────────────┤
           │ match active alerts (PRICE_ABOVE AAPL > 150) │
           │ cooldown gate (last_triggered + N min)       │
