...
┌─────────────────────────────────────────────────────────────────────┐
│                                                                     │
│   📊 Strategy Builder  →  🔬 Backtesting  →  🚀 Live Trading         │
│                                                                     │
│   Create visual         Test against        Execute with            │
│   trading strategies    historical data     real-time data          │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
```
...
| Service | URL |
|---------|-----|
| Frontend | http://localhost:47300 |
| API Gateway | http://localhost:47800 |
| API Docs | http://localhost:47800/docs |
...
<p align="center">
  Built with FastAPI, React, and Alpaca Markets
</p>
